...
### Prerequisite: pre-processed lidar data file for SIO flight #1 of BELS2022 experiments  
...
```
Note that the file naming system reflects the original data organisation: "flight_#2" referred to in the pre-processed data file does correspond to the second flight during that day (1900-1930 on 12 September 2022), and the overall "flight_#1" described in the companion paper. There was no data collection during the first flight on that day.
